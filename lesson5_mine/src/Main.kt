...
interface InMemoryCache<K, V> {
     ...
     */
    fun put(key: K, value: V) { cash[key] = value }
     ...
     */
    fun get(key: K): V? { return cash[key] }
     ...
     */
    fun containsKey(key: K): Boolean { return cash.containsKey(key) }
     ...
     */
    fun isEmpty(): Boolean { return cash.isEmpty() }
}